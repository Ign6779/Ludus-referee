...
class PoseDetector():
    ...
    def findAngle(self, img, p1, p2, p3, draw=True):
        ...
        # Drawing the lines and circles to visualize the angle
        if draw:
...
def main():
    ...
    cap = cv2.VideoCapture("Videos/2022-05-05 11.30.50_Camera 4_4.mov")
    pTime = 0
    ...
    while True:
        ...
        if not success:
            ...
            continue  # Exit the loop if video frame can't be read
